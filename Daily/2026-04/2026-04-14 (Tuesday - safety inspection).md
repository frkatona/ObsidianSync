...
tomorrow
- pick up package
- swap gas + small cylinder

tabs
- modified thin lens equation for laser light (Thor Labs [link](https://www.thorlabs.com/modified-thin-lens-equation-for-laser-light?tabName=Insights))