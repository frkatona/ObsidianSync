...
# Second year exam
2025-06-02
- Adri: on slide 2, how does boron carbide compare to the materials on this group?
	- what is the melting point of boron carbide? <-- not answered
-  John: When does $\ce{B2O3}$ melt? 
	- Yuki: 1800C
	- John, actually, very low melting, maybe like below 500C
	- Yuki: Well, found a paper on this, two papers, with very different temperatures.
		- John: How can you decide if a paper is correct? <--
		- **Need to talk about how to determine if a number makes sense, and where to find good values**
- John: What is the melting point of the $\ce{B4C}$?
	- Yuki: 1600C -- 1800C
	- John: But you said earlier that the use temperature is 2000C, so why $\ce{B4C}$?
		- Yuki: This is a starting point for synthesis. 
			- John: But the title of slide 2 is that this is viable ceramic? Is this viable or not? 
	- so much time was spent on this slide, which doesn't seem useful.  Maybe we have lots of engineers here, but the point is taken that the story could be better. Perhaps, selling $\ce{B4C}$ as a nice model system... 
- Julie: slide 3: is diffusion really a problem here, since the $\ce{B2O3}$ or $\ce{B4C}$ can be above its melting point. 
- Beth: slide 4. Why this polymer backbone? 
	- is there organization, thermal, mechanical property that is desirable? 
	- Yuki: I think the reason (compared to NBD) is that this has a nice stoichiometry for the desired $\ce{B4C}$. 
		- Beth, is the stoichiometry critical?
			- Yuki: we want this as close to the final ratio, <-- but why? 
			- **Maybe have a discussion on solution processability, ability to cast film, etc. 
	- John: Is this approach translatable to other carbides, like ZrC? 
		- Yuki: The organic synthesis processes for the boron carbide cannot be directly applied, but the photothermal conversion of polymer precursors can be. 
			- John: I am confused about the approach here. **Can you tell me what the overall hypothesis is for your work?**
				- Yuki: gives a long explanation
					- John: This is not a hypothesis. Can you make a statement of a hypothesis. 
						- Yuki: tries . Says, we can convert polymer systems to carbides using photothermal heating. 
							- <-- go over what makes a well-formed hypothesis.
							- John: Why not just start with he target ones. 
								- Yuki: We did try, didn't work. $\ce{B4C}$ worked, so we are going to try to understand it, so that we can apply it to others. 
- John: slide 5. What is the maximum power? 
	- Yuki: 60 watts
		- **Most important number is not power, but power density**
- John: how would you measure the thickness?
	- she describes calibers
		- John: not sure these are precise enough
- Adri: Do you have to worry about the oxygen in $\ce{SiO2}$ or $\ce{Al2O3}$ or the hydroscopic water absorbed. can the oxygen transfer from Si -> B? 
	- **Also think about the SiC is formed**
	- **We can look into this** using heats of formation
- Julie: slide 7: is this the best way to estimate the yield? 
	- is there anything else? 
	- John: what did you use to get the percentages? What is the name of the analysis? 
		- Yuki: I do not know <-- **So, make sure you understand the analysis for anything you show**
		- John: What would be a better way to get trustworthy data? 
		- **I feel like you need to think through how to characterize the crystalline vs non crystalline products.**
	- Julie: the reference patterns you show in the XRD are not for boric acid.  So, where are the boric acid peaks. 
		- **So basically, you don't know where these peaks are**
- Beth: Can you walk me through what is going on here.  Does the presence of graphite imply that the stoichiometry is wrong?  Does the presence of boronic acid imply that there is an oxygen source? 
- Adri: slide 14: Do you expect that you will have individual H atoms or B atoms? reminder: you are at 250C? 
	- Yuki: not really an answer
		- Adri: Do you have a rough idea of the B-H bond strength, relative to the C-H bond?
			- **Need to review how to think through a mechanism like this** <-- come talk to me and Anthony to talk through what is going on. 
- Julie: This gets us to boron clusters... but not $\ce{B4C}$. How do you get to $\ce{B4C}$?
	- Beth: What causes B-C bonds to form?


- Julie: slide 15: how do you plan to analyze the results, so that we can conclude what you have and how much, etc. what techniques will you use, and why are they the correct things to use. 
	- Yuki: SEM, XRD, GC-MS (for species present), <- What about TGA? 
		- Beth: How can you distinguish between all the boron-containing species. 
		- how do you know you have $\ce{B4C}$
		- **Need to have a talk about how MS is not great at quantifying**



**Committee comments**
Fail, but retake and try to do this in the Fall. 

Read up on the fact that boron is a great hydrogen storage material
Read up on boron being a very stable material
- Better understanding of materials
- Perhaps structure by hypothesis and 
	- 
- Document is much more forward looking
	- Do not focus on what you have done, but one what you will do. 


Moved on to outside proposal.

AK comments:
- why is is conventional not do-able
